export function decision(s,strategy='adaptive',path='left'){
 ...
 for(const h of s.hazards){if(h.warn>0)continue;const future={x:h.x+h.vx*.45,y:h.y+h.vy*.45};if(Math.hypot(future.x-s.x,future.y-s.y)<40){tx=s.x+(h.x<s.x?65:-65);ty=440;}}
