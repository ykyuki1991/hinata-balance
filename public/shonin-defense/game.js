import {Game,H,VERSION} from './engine.js?v=6.0.0';
import {Renderer} from './render.js?v=6.0.0';
import {AudioDirector} from './audio.js?v=6.0.0';
...
try{const saved=JSON.parse(localStorage.getItem('shonin-defense-v6')||'null');for(const k of Object.keys(records))if(Number.isFinite(saved?.[k]))records[k]=Math.max(0,saved[k]);}catch{}
