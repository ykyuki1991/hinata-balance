import {Game,W,H,STAGES,UPGRADES,VERSION} from './engine.js?v=3.0.0';
import {Renderer} from './render.js?v=3.0.0';
import {AudioDirector} from './audio.js?v=3.0.0';
...
function overlayBase(){blockGestureClick=!!pointer;clearInput();$('splash').hidden=true;$('overlay').hidden=false;$('modes').hidden=true;$('upgrades').hidden=true;$('result').hidden=true;$('medals').hidden=true;$('best-wrap').hidden=true;}
