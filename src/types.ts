...
export type Result={mode:Mode;count:number;target:number;seconds:number;clear:boolean;used:Member[];score?:number;perfects?:number;averageTilt?:number;maxTilt?:number;failureReason?:string;order?:string[];boardImage?:string};
